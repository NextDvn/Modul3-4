          ...
          <table class="table table-striped ">
            ...
            <tbody>
              ...
              foreach ($pinjam as $p ) { ?>
                    ...
                    <td><?= date('d F Y', strtotime($p['tgl_pinjam'])) ?></th>
                      <td><?= date('d F Y', strtotime($p['tgl_jatuh_tempo'])) ?></th>
                        ...
                        <td>
                          ...
                          <a href="form-edit.php?id_pinjam=<?= $p['id_pinjam']?>" class="badge badge-success">Edit</a>
                ...
                <a href="http://localhost/siperpus/transaksi/form-pinjam.php" class="btn btn-secondary">Tambah</a>
              </div>
            </div>
          </div>
        </div>
